...
$route['transaksi/create'] = 'admin/TransaksiController/create';
$route['transaksi/save_batch'] = 'admin/TransaksiController/save_batch';
$route['transaksi/export_pdf'] = 'admin/ExportController/export_pdf';
$route['transaksi/export_excel'] = 'admin/ExportController/export_excel';
