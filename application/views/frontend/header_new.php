        ...
        <header class="header_section">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="index.php?ref=beranda">
                        <img src="assets/img/logo/logo_kelatra.png" alt="Logo" style="height: 40px; margin-right: 10px;">
                        <span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="user_option-box">
                            ...
                            <!-- Jika tidak di halaman auth, tampilkan link ke login/register -->
