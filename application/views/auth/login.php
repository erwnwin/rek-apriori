            ...
            <div class="login-form">
                ...
                <form id="loginForm">
                    ...
                    <div class="form-group remember-me-container">
                        <button type="submit" name="login" value="Login" class="btn btn-primaryku btn-block" id="btnLogin">
                ...
                <div class="links-container">
                    <a href="<?= base_url('register') ?>" class="lupa-password">Belum Punya Akun? Registrasi dulu!</a>
